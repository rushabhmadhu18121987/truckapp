...
(function(g) {
  ...
  function A(a, b) {
      ...
      for (var e = 0, f = a.body.length; e < f && !(c = a.body[e][b].toString(), -1 !== c.indexOf("\n") ? (c = c.split("\n"), c.sort(function(a, b) {
              return b.length - a.length
          }), c = c[0].length) : c = c.length, c > d && (d = c), 40 < d); e++);
      d *= 1.3;
      return 6 < d ? d : 6
  }
          ...
          if (g.isPlainObject(d)) v(d);
              ...
              if (n) {
                  ...
                  for (e = c.attributes.length - 1; 0 <= e; e--) {
                      ...
                      var q = c.attributes[e].nodeValue; - 1 !== f.indexOf(":") && (h.push({
                          name: f,
                          value: q
                      }), c.removeAttribute(f))
                  }
                  e = 0;
                  for (f = h.length; e < f; e++) q = d.createAttribute(h[e].name.replace(":", "_dt_b_namespace_token_")), q.value = h[e].value, c.setAttributeNode(q)
              }
              c = w.serializeToString(d);
              n && (-1 === c.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' +
  ...
  h.Client.prototype = {
      ...
      getHTML: function(a, b) {
          ...
          if (navigator.userAgent.match(/MSIE/)) var e = location.href.match(/^https/i) ? "https://" : "http://",
              d = d + ('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' +
  ...
  var x = function(a, b) {
      ...
      y = function(a, b) {
          for (var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n", c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), h = b.escapeChar !== p ? b.escapeChar : "\\", k = function(a) {
                  for (var b =
                          "", c = 0, d = a.length; c < d; c++) 0 < c && (b += f), b += e ? e + ("" + a[c]).replace(g, h + e) + e : a[c];
                  return b
              }, l = b.header ? k(c.header) + d : "", j = b.footer && c.footer ? d + k(c.footer) : "", m = [], u = 0, C = c.body.length; u < C; u++) m.push(k(c.body[u]));
          return {
              str: l + m.join(d) + j,
              rows: m.length
          }
  ...
  i.ext.buttons.excelFlash = g.extend({}, t, {
      ...
      action: function(a, b, d, c) {
              ...
              k, l, i = function(a) {
                  ...
                  for (var b = 0, c = a.length; b < c; b++) {
                      ...
                      if (!(null === a[b] || a[b] === p || "" === a[b])) {
                          ...
                          j || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? j = m(f, "c", {
                              attr: {
                                  t: "n",
                                  r: d
                              },
                          ...
                          }) : (i = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), j = m(f, "c", {
                              attr: {
                                  t: "inlineStr",
                                  r: d
                              },
          ...
          c.footer && b.footer && (i(b.footer,
              e), g("row:last c", f).attr("s", "2"));
          i = m(f, "cols");
          g("worksheet", f).prepend(i);
          j = 0;
          for (n = b.header.length; j < n; j++) i.appendChild(m(f, "col", {
              attr: {
                  min: j + 1,
                  max: j + 1,
                  width: A(b, j),

...
<div class="sidebar-category sidebar-category-visible">
    <div class="category-content no-padding">
        <ul class="navigation navigation-main navigation-accordion">
            ...
            <li <?php echo (Request::segment(1) == 'vehicleCat') ? 'class="active"' : ""; ?>><a href="{{ url('vehicleCat') }}"><i class="icon-width"></i> <span>Vehicle Category</span></a></li>
            ...
            <li <?php echo (Request::segment(1) == 'promocode') ? 'class="active"' : ""; ?>><a href="{{ url('promocode') }}"><i class="icon-gift"></i> <span>Promo codes</span></a></li>
